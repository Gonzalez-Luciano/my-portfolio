      ...
      <div className="transition-transform duration-500 2xl:mx-48">
        <div className="flex justify-center sm:ml-9 flex-col-reverse md:flex-row">
          ...
          <div className="p-8">
            ...
            <p
              href="#"
              className={`block mt-1 text-3xl leading-tight font-medium  bg-gradient-to-r from-blue-500 via-orange-500 to-yellow-300 text-transparent bg-clip-text opacity-0 ${
                !showOverlay
